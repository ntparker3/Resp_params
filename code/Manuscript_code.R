...
##### Shown below is a sample of the code used to run the analysis to parameterize progressions
##### through the healthcare utilization cascade for respiratory diseases. We show here sample code
##### for the influenza analysis and for a subset of the progressions (from symptom onset and
##### emergency visit as starting events) for brevity, though the same code can be used to repeat the
##### analyses for other diseases and progressions. The required data is time-to-event healthcare
##### utilization data (see below for example of the structure of the data). Any questions or
##### necessary clarifications can be directed to noahtparker3@berkeley.edu. 
#####
