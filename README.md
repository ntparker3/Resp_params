...
``` r
test.table2 <- read_csv("~/Desktop/test2.csv")
```
...
``` r
kable(test.table2, col.names = c("Starting State", "First Event", "Distribution", "Parameters Estimate", "Total Probability", "Probability at t = 15", "Median Time To Event", "25th% Time", "75th% Time"), align = "c")
```
...
```
    ...
    ## ── Column specification ────────────────────────────────────────────────────────
    ## Delimiter: ","
    ## chr (8): Starting_state, First_Event, Distrubtion, Total _Prob, Prob_t_15, M...
    ## dbl (3): Parameter 1, Parameter 2, Parameter 3
    ## 
    ## ℹ Use `spec()` to retrieve the full column specification for this data.
    ## ℹ Specify the column types or set `show_col_types = FALSE` to quiet this message.
